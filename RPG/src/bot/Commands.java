...
public class Commands extends ListenerAdapter {
	...
	TreeMap <Long, Integer> users = new TreeMap <Long, Integer>();
	...
	public void onGuildMessageReceived (GuildMessageReceivedEvent event) {
		...
		//!get players
			...
			Long [] usersA = this.users.keySet().toArray(new Long[this.users.size()]);
			String str = "Members:\n";
			for (Long i: usersA) {
				str += i.toString() + "  Value: "+ this.users.get(i) +"\n";
			}
